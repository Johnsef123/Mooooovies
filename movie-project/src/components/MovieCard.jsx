...
export function MovieCard({ movie, onMovieUpdated }) {
    ...
    return (
        ...
        <Link className="movie-card" to={`/MovieDetails/${movie.id}`}>
            ...
            <div className="movie-body">
                ...
                <WatchlistButton movie={movie} onMovieUpdated={onMovieUpdated} className="card-watchlist-button" />
            </div>
        </Link>
